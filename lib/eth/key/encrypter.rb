...
class Eth::Key::Encrypter
  ...
  # encryption.
  #
  # @param key [String] representing a secret key used for encryption
  ...
  # Output containing the encrypted key and [other identifying data](https://github.com/ethereum/wiki/wiki/Web3-Secret-Storage-Definition#pbkdf2-sha-256)
  def data
    # default to pbkdf2
