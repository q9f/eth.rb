...
describe Abi do
  describe ".encode .decode" do
    ...
    it "can encode numbers from string inputs" do
      expect(Abi.encode(["uint256"],["10000000000000000000000"])).to eq "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02\x1E\x19\xE0\xC9\xBA\xB2@\x00\x00"
      expect(Abi.decode(["uint256"],"00000000000000000000000000000000000000000000021e19e0c9bab2400000")).to eq [10000000000000000000000]
      expect(Abi.encode(["int256"],["20000000000000000000000"])).to eq "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x04<3\xC1\x93ud\x80\x00\x00"
