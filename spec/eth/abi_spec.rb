  ...
  describe ".encode .decode" do
    ...
    describe "dynamic encode" do
      ...
      it "can encode array of dynamic structs" do
        encoded = Eth::Util.bin_to_hex(described_class.encode(["tuple(string,string)"], [{id: "id", name: "name"}, {id: "id", name: "name"}, {id: "id", name: "name"}]))
        expected = ""
        expect(encoded).to eq(expected)
      end
    end
